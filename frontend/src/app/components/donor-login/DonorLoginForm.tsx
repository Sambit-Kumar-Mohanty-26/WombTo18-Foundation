      ...
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="identifier" className="text-sm font-medium text-[#d1f5e0]/90">
              Email or Donor ID
            </Label>
            <Input
              id="identifier"
              ...
              {...register("identifier")}
              className="bg-[#0a3a1e]/60 border-white/10 text-white placeholder:text-[#d1f5e0]/30 focus-visible:ring-primary"
            />
            {errors.identifier && (
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-[#a7e8c3]/50">

      ...
      <ScrollReveal className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {programs.map((program) => (
            <Card key={program.title} className="group bg-emerald-950/20 hover:shadow-lg transition-all duration-300 border-white/10 hover:border-primary/20 text-white">
              <CardHeader>
                ...
                <CardDescription className="text-sm text-emerald-200/50">{program.description}</CardDescription>
              </CardHeader>
            </Card>
          ))}
        </div>
